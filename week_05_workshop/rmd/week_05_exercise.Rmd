...
Additionally, 3 variables of class "character" should be converted to factors. There are also 4 variables that should be numeric. We need to change all 7 variables to correct type, because this will be essential for further manipulations and for plotting!
...
The due date for the assignment is Friday, February 9th at 23:59 PM UTC.
